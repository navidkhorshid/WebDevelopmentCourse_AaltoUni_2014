...
function getPic(i,j) {
    ...
    switch (x[i][j]) {
        case 1:
            ...
            break;
        case 2:
            picture = "img/green.png";
            break;
        case 3:
            picture = "img/blue.png";
            break;
        case 4:
            picture = "img/white.png";
            break;
        default:
            picture = "img/white.png";
            break;
...
$(document).ready(function () {
    ...
    for (var i = 0; i < 9; i++) {
        ...
        for (var j = 0; j < 9; j++) {
            ...
            x[i][j] = Math.floor(Math.random() * numberOfJewels) + 1;
            var pic = getPic(i, j);
            $('#board table tr:last-child').append('\n\t <td id=\"' + i + j + '\"> <img src=\"' + pic + '\" alt=\"\" width=\"50\" height=\"50\"> </td>');
        }
    }
